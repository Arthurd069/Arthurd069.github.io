...
```yml
# Site settings
title: Arthurd Blog             # title of your website
SEOTitle: Arthurd Blog          # check out docs for more detail
description: "Cool Blog"    # ...

# SNS settings      
github_username: arthurd069     # modify this account to yours
...
sidebar-avatar: /img/header.jpg     # use absolute URL.
```
...
the SEO Title is introduced to solve this problem, you can set `SEOTitle` different from `title`, and it would be only used to generate HTML `<title>` and setting DuoShuo Sharing.
