...
### [我的博客在这里 &rarr;](http://Arthurd069.github.io)
...
```
# Site settings
title: Arthurd Blog             # 你的博客网站标题
SEOTitle: Arthurd Blog			# 在后面会详细谈到
description: "Cool Blog"    # 随便说点，描述一下

# SNS settings      
github_username: Arthurd069     # 你的github账号
...
sidebar-avatar: /img/header.jpg     #你的大头贴，请使用绝对地址.
```
...
我的博客标题是 **“Arthurd Blog”** 但是我想要在搜索的时候显示 **“老贺的博客 | Arthurd Blog”** ，这个就需要SEO Title来定义了。

其实这个SEO Title就是定义了<head><title>标题</title></head>这个里面的东西和多说分享的标题，你可以自行修改的。

## 致谢

1. 这个模板是从这里[黄玄的博客](https://github.com/Huxpro/huxpro.github.io)  fork 的。 感谢作者。
